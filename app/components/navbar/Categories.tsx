...
import {GiBarn,GiWindmill,GiCastle, GiIsland, GiBoatFishing, GiForestCamp, GiCaveEntrance, GiCactus} from 'react-icons/gi';
...
export const categories = [
    ...
    },
    {
        label: 'Lux',
        icon: IoDiamond,
        description: 'This property is lusurious!'
    },
